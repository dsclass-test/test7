...
ksvm_Model <- ksvm(StatisfactionType ~Scheduled.Departure.Hour_Early_Morning+Type.of.Travel_Mileage.tickets+Type.of.Travel_Business.travel+Flight.Distance+Flight.time.in.minutes+Departure.Delay.in.Minutes+Arrival.Delay.in.Minutes+Class+Shopping.Amount.at.Airport+No.of.Flights.p.a.+Year.of.First.Flight+Price.Sensitivity+Age+Gender+Airline.Status , data=dfSVMTrain, kernel = "rbfdot", kpar = "automatic", C = 10, cross = 10, prob.model = TRUE)
